...
export default () => (
    <Layout>
        <Head>
            <title>Alfian Maulana | Askaraga</title>
            <meta name="description" content="Askaraga" />
        </Head>
        ...
        <div id="main" className="alt">
            <section id="one">
                <div className="inner">
                    ...
                    <p><a href="https://www.arkavidia.id/" target="_blank">Askaraga</a> is an annual HMIF ITB prestigius event that has different theme every year. This year, Arkavidia 6.0, theme is "Embracing Our Nation in Digital Transformation".</p>
