    ...
    <footer id="footer">
        <div className="inner">
            <ul className="icons">
                ...
                <li><a href="#phone-number" className="icon alt fa-telegram"><span className="label">Telegram</span></a></li>*/}
            ...
            <ul className="copyright">
                <li>Alfian Maulana (2020)</li><li>&copy; Forty</li><li>Design: <a href="https://html5up.net">HTML5 UP</a></li>
            </ul>
        </div>
    </footer>
)
